...
def test_extract_semantics_success(
    ...
    # Assert no output to stdout
    captured = capsys.readouterr()
    assert captured.out == "", "Expected no output to stdout"
        ...
        expected_result = SemanticResult(
            rooms=[
                RoomLabel(
                    name="Room 1",
                    approximate_center_x=100.0,
                    approximate_center_y=100.0,
                ),
                RoomLabel(
                    name="Room 2",
                    approximate_center_x=200.0,
                    approximate_center_y=200.0,
                ),
            ],
            scale=ScaleInfo(text="1/4\" = 1'", pixels_per_unit=18.0),
...
def test_room_label_creation():
    ...
    room = RoomLabel(
        name="Living Room", approximate_center_x=100.0, approximate_center_y=200.0
    )
...
def test_semantic_result_multiple_rooms():
    ...
    result = SemanticResult(
        rooms=[
            RoomLabel(
                name="Kitchen", approximate_center_x=100.0, approximate_center_y=100.0
            ),
            RoomLabel(
                name="Bedroom", approximate_center_x=200.0, approximate_center_y=200.0
            ),
            RoomLabel(
                name="Bathroom", approximate_center_x=300.0, approximate_center_y=100.0
            ),
        ],
